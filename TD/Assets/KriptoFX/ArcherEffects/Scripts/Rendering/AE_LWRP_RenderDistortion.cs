...
public class AE_LWRP_RenderDistortion: MonoBehaviour, IAfterTransparentPass
{
    public bool IsActive = true;
    private AE_CustomDistortionImpl customustomDistortionImpl;
    ...
    {
        if (customustomDistortionImpl == null) customustomDistortionImpl = new AE_CustomDistortionImpl();
...
public class AE_CustomDistortionImpl : ScriptableRenderPass
{
    public bool IsActive = true;
    ...
    public AE_CustomDistortionImpl()
    {
